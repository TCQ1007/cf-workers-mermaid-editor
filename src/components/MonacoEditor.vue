      ...
      if (props.language === 'mermaid') {
        if (!monaco.languages.getLanguages().find(lang => lang.id === 'mermaid')) {
          ...
          monaco.languages.setMonarchTokensProvider('mermaid', {
            tokenizer: {
              root: [
                [/^(graph|flowchart|sequenceDiagram|classDiagram|stateDiagram|gantt|pie|gitgraph|erDiagram|journey|mindmap|timeline|quadrantChart|requirementDiagram|c4Context|c4Container|c4Component|c4Dynamic)\b/, 'keyword'],
